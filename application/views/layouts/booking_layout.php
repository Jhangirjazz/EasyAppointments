...
<head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="<?= asset_url('assets/css/themes/' . vars('theme') . '.css') ?>"> -->
     <link rel="stylesheet" type="text/css" href="<?= asset_url('assets/css/themes/' . vars('theme') . '.css') ?>?v=<?= time() ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.documentElement.style.setProperty('--bs-body-bg', '#0C0C0C', 'important');
});
</script>
