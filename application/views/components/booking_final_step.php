...
<div id="wizard-frame-4" class="wizard-frame" style="display:none;">
    <div class="frame-container">
        <h2 class="frame-title"><?= lang('Booking Request Summary') ?></h2>
            ...
            <!-- ADD SERVICE INFO HEADING -->
        <div class="row frame-content m-auto pt-md-4 mb-4"></div>
            <div class="col-12">
        ...
        <div class="row frame-content m-auto pt-md-4 mb-4">
            <div class="col-12 col-md-6">
                ...
                <div id="category-display" 
                     ...
                     style="color: #ffffff; font-size: 1.4rem; letter-spacing: 1px; padding-top: 0.5rem ; margin-top: 1.666rem;">              
                </div>
